...
Denmark did not persuade its citizens to adopt digital public services; it required them to do so. *Lov om Offentlig Digital Post* (Denmark 2012) made a state-run digital mailbox the default legal channel for public correspondence, binding businesses from 2013 and every citizen aged 15 and over from 1 November 2014. Digitaliseringsstyrelsen (2025a) records that the accompanying identity credential, NemID, was replaced by MitID from October 2021 and withdrawn on 31 October 2023. The combination is what distinguishes the Danish case. A mandate alone changes how letters are sent; a mandate plus a universal credential establishes shared authentication infrastructure that every citizen must hold and any firm may build upon without financing its adoption, lowering the fixed cost of every service developed on it. Because compulsion accounts for citizens' use, the economic interest lies in what others built on that foundation.

**Retail banking.** Finans Danmark (2025) reports that Danish retail bank branches fell from 2,025 in 2004 to 665 in 2024, a decline of 67.2% (Figure 1). Taken alone that suggests digitalisation eliminated banking employment, but the longer series qualifies it. Between 1991 and 2024 the number of financial institutions fell by 76.7%, from 219 to 51, while bank employment fell by only 29.4%, from roughly 51,000 to 36,000 (Figure 2). Staff per surviving institution therefore rose from 233 to 706, an increase of 203%. The business model changed rather than the workforce: with authentication and correspondence on shared national infrastructure, branch networks became redundant as a distribution channel and the sector consolidated into fewer and larger institutions. The three series begin in different years and must not be differenced.

**Retail payments.** Danmarks Nationalbank (2025) reports that cash fell from 23% to 9% of the *number* of payments in physical retail between 2017 and 2025, while card-based mobile wallets reached 32% of the same measure (Figure 3). Much of this is displacement within digital instruments rather than new digitalisation, because wallet payments are card payments and the physical card share fell from 73% to 54%. What changed for consumers was the interface, not the rails underneath, which is precisely the kind of innovation that shared infrastructure makes cheap to attempt. Cash acceptance nonetheless remains a statutory obligation under *lov om betalinger* §81 (Finanstilsynet 2025).

**Broader economic effect.** Whether wider consumer adoption is associated with greater commercial activity can be tested directly. Using Eurostat data (2026), Figure 4 plots the share of internet users purchasing online against e-sales as a share of enterprise turnover across the European Union in 2024, the turnover measure from a separate extract (Eurostat 2025c). Across the 18 member states reporting both, the fitted slope is +0.602 percentage points of turnover per percentage point of adoption, with a standard error of 0.105 and an R² of 0.674. Appendix A reports the diagnostics. Causation is not established: adoption is measured on consumers and turnover on enterprises, and national income appears on neither axis. Denmark sits above the fitted line by less than one residual standard error and behind three other states, consistent with the European pattern rather than exceptional to it.
...
![Figure 2. Danish banking consolidation: institutions, branches, employment; differing base years. Finans Danmark; workbook F9.](figures/fig2_consolidation.png)
...
**The problem both policies address.** Denmark leads Europe on citizen adoption and not on firm capability. Eurostat (2026) records that 90.86% of Danish internet users bought online in 2024, third of the twenty-seven member states, while only 38.78% of Danish enterprises make any e-sales, second in the Union behind Lithuania at 43.03% and still under two firms in five (Eurostat 2025b). Intensity rose where breadth did not: e-sales grew from 17.05% of enterprise turnover in 2014 to 33.31% in 2024, against an EU-27 average moving from 16.43% to 19.49% (Figure 5). The same split governs the newest technology. The European Commission (2026) reports that 42.03% of Danish enterprises used artificial intelligence in 2025, comprising 74.52% of large firms against 40.99% of small and medium ones, a gap of 33.53 percentage points (Figure 6). This is not a connectivity failure, since 92.45% of Danish SMEs clear the basic digital-intensity threshold against an EU average of 71.39%. What smaller firms lack is the complementary capital, namely data, systems integration and specialist staff, that converts access into application.

**The two instruments.** Denmark's SMV:Digital and Germany's *Digital Jetzt* share an objective, which is to raise digital investment among firms that would not otherwise make it, and both operate as co-financed grants to small and medium enterprises. They differ in how they choose recipients. SMV:Digital scores applications and funds the highest scorers until the pool is exhausted, the next pool opening on 26 October 2026 (SMV:Digital 2026); *Digital Jetzt* allocated by lottery among eligible applicants.

**Effectiveness.** Denmark's scheme is the better evidenced of the two. Digitaliseringsstyrelsen (2025b) links recipients to Danmarks Statistik registers and compares them with matched control firms, reporting revenue growth of 18% against the controls' 13% and employment growth of 8% against 4%. Germany has no comparable estimate, and its allocation rule produced a perverse result: the Bundesrechnungshof (2022) found that firms postponed investment while waiting for a favourable draw and recommended that the procedure be discontinued. A lottery makes the grant a prize worth waiting for, and waiting is the opposite of the behaviour the scheme exists to produce.

**Weaknesses and implementation challenges.** Denmark's advantage is narrower than it appears. Matching addresses selection on what the registers record, namely sector, size, age and prior trajectory, and not on what they do not. Selection into a voluntary scheme runs on managerial ambition, an existing digitalisation plan and the slack to write an application, which are the traits that also produce revenue growth. The matched estimate therefore retains an upward bias of unknown size, and neither scheme reaches firms that never apply.

**Recommended improvement.** SMV:Digital already scores applicants, so it already produces a funding threshold; it simply discards the information. Near the cut-off, whether a firm is funded turns on assessor variation rather than on the firm, which makes applicants just above and just below comparable on exactly the unobservables that defeat matching. Retaining the scores and publishing the cut-off would allow a regression discontinuity estimate at administrative cost only, with no change to who receives money. Appendix B specifies the design.
...
Sustainable Development Goal 12, on responsible consumption and production, is the goal Danish digitalisation has most clearly moved, and it has moved it in both directions. Digital infrastructure substitutes information for materials at the point of use and creates a new material stream at the point of disposal. Denmark is unusually far along the first and unusually far behind on the second.

**Positive contribution.** The mandate's audited benefit is a dematerialisation benefit. Rigsrevisionen (2016) could verify roughly DKK 450 million a year of the projected saving from compulsory Digital Post, and the verified component is precisely postage, paper and envelopes. That is a financial figure rather than a tonnage, so it prices the paper avoided rather than weighing it, but the substitution is real and applies to correspondence with every adult in the country. The payment system shows the same substitution privately: cash fell from 23% to 9% of physical retail payments between 2017 and 2025 (Danmarks Nationalbank 2025), removing the printing, transport, storage and destruction physical currency requires.

**The remaining challenge.** Denmark performs the disposal side badly. The European Commission (2026) reports that Denmark recycled or prepared for reuse 15.37% of the ICT waste it collected in 2023, against an EU-27 average of 80.23%, a gap of roughly 65 percentage points (Figure 7). The denominator matters and narrows the claim: the base is ICT waste *collected*, so the indicator describes what happens to devices that reach the waste stream and is silent on how many never do. On the measure that exists, a country at or near the top of the Union on almost every digital indicator sits near the bottom on this one.

**Indicator trend.** No trend can be reported. The source publishes a single year for this indicator, so the 15.37% is a level and not a direction, and the report makes no claim about whether Danish performance is improving.

**What this implies.** The two halves are connected by the same policy. A mandate that requires every adult to transact digitally also requires every adult to hold a device capable of running MitID, so the state has taken a deliberate decision to raise the number of devices in circulation while leaving their end of life to a system recovering a fifth of the European average. Denmark has treated dematerialisation as the environmental case for digitalisation and has not treated circularity as its cost.
...
**The group and the policy.** The mandate's effects fall most heavily on the oldest citizens, and the only relief available to them is statutory exemption from Digital Post. Digitaliseringsstyrelsen (2026) reports that 20% of Danish citizens aged 75 to 84 hold a formal exemption, rising to 33% among those 85 and over, so one in three of the oldest cohort sits outside a compulsory system. Those are 2022 figures and the rate below is from 2026, so the two are complementary measures rather than points on a trend.

**Effectiveness.** In the first quarter of 2026, 4.7% of citizens aged 15 and over, or 238,479 people, were exempt. Exemption is the narrowest available measure of the problem. Figure 8 sets it against four wider estimates, which are not comparable because measure, year and denominator all differ; Appendix C reconciles them. The European Commission (2026) reports that 6.5% of Danes do not use digital public services and 16.5% report difficulty using them, while Digitaliseringsstyrelsen (2025c) and Justitia (2022) put the widest estimates at about a quarter of adults. The counts are clearer than the percentages: exemption reaches 238,479 people, while 16.5% of 6,025,603 (Danmarks Statistik 2026) is roughly 994,000. On the order of three-quarters of a million Danes therefore struggle with a compulsory system while holding no standing outside it.

**The barrier is administrative, not a skills deficit.** Denmark's weakest age band, those aged 55 to 74, reaches 67.81% with at least basic digital skills against an EU average of 42.60%, and Denmark leads the Union in all three bands (Figure 9). The mandate is calibrated above the bottom of its own distribution, and the exemption criteria are drawn more narrowly than the difficulty they relieve.

**Recommendation.** The exemption criteria should be widened to admit documented difficulty rather than only the listed statutory grounds. Denmark has already solved the adjacent problem: Folketinget (2023) provided that from June 2023 an exempt citizen is entitled, on request, to a non-digital alternative to any mandatory self-service solution. That reform decoupled the channel from the obligation but left the qualifying criteria untouched, because the right runs only to those already exempt. The Conseil d'État (2022) and the Belgian Cour constitutionnelle (2025) have since attached the entitlement to the difficulty rather than to a prior status (Appendix D).

![Figure 8. Five estimates of Danish digital exclusion; denominators and years differ. Workbook F4.](figures/fig6_exclusion.png)

*Figure 8. Five estimates of Danish digital exclusion; denominators and years differ. Workbook F4.*

![Figure 9. Basic digital skills by age band, Denmark and EU-27, 2025. European Commission; workbook F10.](figures/fig7_skills.png)

*Figure 9. Basic digital skills by age band, Denmark and EU-27, 2025. European Commission; workbook F10.*

---

## Question 5. Guest speaker reflection: AI, sustainability and the Danish digital economy

The session addressed corporate sustainability at PwC rather than digital government, and the connection to Denmark was not one I expected. It rests on an idea running through both halves of the talk: adoption is easy to claim and effect is hard to prove, so what separates them is whether somebody other than the claimant does the measuring.

Tran (2026) reported that in a PwC survey of Asia-Pacific chief executives, 82% had adopted generative artificial intelligence within five years while far fewer could identify revenue attributable to it. Denmark shows the same gap in its own data. Adoption is high by European standards at 42.03% of enterprises, and it is concentrated: 74.52% of large firms against 40.99% of small and medium ones. Access has been distributed and capability has not, which is the finding Question 2 reaches from Danish evidence and the guest speaker reached from a regional survey.

The sustainability half supplied the test. Tran's position was that a corporate net zero commitment means little unless an external body has validated it, because an unvalidated commitment is one the claimant grades itself; PwC's own reduction of 22% against a 2019 baseline is stated against a target the Science Based Targets initiative validated. Applied to Denmark, that standard is uncomfortable. SMV:Digital's headline figures are reported by participants to the body funding the scheme (Digitaliseringsstyrelsen 2025b), which is why Question 2 recommends an evaluation the agency does not run. Denmark's position on ICT waste recovery is measured and published by the European Commission and has not produced a corresponding target, which is disclosure without commitment rather than the reverse.

One detail transfers directly to policy. Tran put the cost of that validation at USD 10,000 to 25,000, which in practice restricts it to large corporations, and described publicly funded programmes that extend equivalent capability to smaller firms. That is the same instrument, and the same justification, as SMV:Digital. A fixed cost of proving anything, whether emissions or returns, is heavier the smaller the firm bearing it, and closing that gap is a government function in both domains.
...
That test has a limit worth stating, because it is the strongest objection to this section. Balance on the regressor is not balance on the outcome, and the reasons a national statistical institute fails to publish an e-sales turnover figure are not all random with respect to economic structure. Eurostat requires turnover at basic prices excluding VAT, and rejects national submissions failing coherence checks against Structural Business Statistics. Web and EDI sales behave differently, since EDI carries industrial business-to-business volume, so a small change in which large manufacturers fall into the sample can move a national share by several points. And secondary suppression removes a national total outright where one or two dominant firms in a NACE division would let their figure be recovered by subtraction. That last mechanism is the troubling one: it makes missingness a function of market concentration, which is plausibly related to enterprise e-commerce intensity. A balance test on consumer adoption cannot detect it. The honest statement is that the nine are missing for administrative and disclosure reasons rather than for anything this section could observe, which is weaker than missing at random and stronger than selected on the outcome.
...
Question 2 recommends restructuring SMV:Digital's allocation so that the scheme can measure its own effect, is a research design as much as a policy, and a design is only as good as its specification. This appendix states it at the level of detail an administering agency would need to act on it.
...
Question 4 reports five estimates of Danish digital exclusion ranging from 4.7% to 25%. They are not five measurements of one quantity, and this appendix sets out why, because the spread is the finding rather than an embarrassment.
...
![Figure C1. The exclusion estimates converted to people on their own bases.](figures/figA_d1_denominators.png)

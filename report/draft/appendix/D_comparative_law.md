...
[[CE1]]. The court accepted that a regulatory authority may compel the use of a
digital service. It held that the obligation is lawful only where users retain
normal access to the public service and can exercise their rights effectively, and
that this must be assessed *in concreto* against five criteria: the object of
...
Two remedies followed. The administration must provide support for users who need
it, and a non-digital substitute route where the digital one fails. The reasoning
...
non-digital and deliver an equivalent level of service. And the obligation does
